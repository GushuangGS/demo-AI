...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,10.1.12.219";
  const port = "8090";
  const id = "mp-weixin_qLfhyY";
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","10.1.12.219"],"servePort":7001,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"mike-demo","spaceId":"mp-13e9d321-74c2-46f9-927e-bf7488cfe27f","clientSecret":"RSsHsXuidzl/HXC7h9iNJQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__DCFB923";
} catch (e2) {
